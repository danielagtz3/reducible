...
def insert_word(s, hash_table):
    ...
    while hash_table[index] != "":
        if hash_table[index] == s:
            return  # Duplicate found, no need to insert again
...
# TODO: Modify this function. You may delete this comment when you are done.
def is_reducible(s: str, hash_table: list, hash_memo: list) -> bool:
    """
...
# TODO: Modify this function. You may delete this comment when you are done.
def get_longest_words(string_list: list) -> list:
    """
